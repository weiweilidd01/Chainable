...
//        static var TableViewShouldSpringLoadRowAtIndexPathWithContextKey = "TableViewShouldSpringLoadRowAtIndexPathWithContextKey"
    ...
    fileprivate var commitEditingStyleForRowAtIndexPathBlock:((UITableView, UITableViewCell.EditingStyle, IndexPath)->())? {
        get {
            return objc_getAssociatedObject(self, &TableViewKey.TableViewCommitEditingStyleForRowAtIndexPathKey) as? ((UITableView, UITableViewCell.EditingStyle, IndexPath) -> ())
        }
        set(value) {
            setDataSource()
    ...
    fileprivate var editingStyleForRowAtIndexPathBlock:((UITableView, IndexPath)->(UITableViewCell.EditingStyle))? {
        get {
            return objc_getAssociatedObject(self, &TableViewKey.TableViewEditingStyleForRowAtIndexPathKey) as? ((UITableView, IndexPath) -> (UITableViewCell.EditingStyle))
        }
        set(value) {
            setDelegate()
...
extension UITableView {
    ...
    public func setCommitEditingStyleForRowAtIndexPathBlock(_ handler: @escaping((_ tableView: UITableView, _ editingStyle: UITableViewCell.EditingStyle, _ indexPath: IndexPath)->())) {
...
//    }
    ...
    public func setEditingStyleForRowAtIndexPathBlock(_ handler: @escaping((_ tableView: UITableView,_ indexPath: IndexPath)->(UITableViewCell.EditingStyle))) {
